...
public interface SpecialEffectSettings {
    ...
    interface Mutable extends SpecialEffectSettings {
        ...
        Mutable setAmbientParticle(@Nullable AmbientParticleSettings settings);
        
        Mutable setAmbientLoopSound(@Nullable SoundEvent sound);
        
        Mutable setAmbientMoodSound(@Nullable AmbientMoodSettings settings);
        
        Mutable setAmbientAdditionsSound(@Nullable AmbientAdditionsSettings settings);
