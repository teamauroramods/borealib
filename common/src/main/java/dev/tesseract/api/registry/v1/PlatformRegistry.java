...
import dev.tesseract.impl.registry.VanillaPlatformRegistry;
...
/**
 * The base class for registering
 *
 * @param <T>
 */
public interface PlatformRegistry<T> extends Keyable, IdMap<T>, Iterable<T> {
