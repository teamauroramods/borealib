...
public final class MagnetosphereItemTags {
    ...
    public static final TagKey<Item> DYES_BLACK = tag("dyes_black");
    public static final TagKey<Item> DYES_RED = tag("dyes_red");
    public static final TagKey<Item> DYES_GREEN = tag("dyes_green");
    public static final TagKey<Item> DYES_BROWN = tag("dyes_brown");
    public static final TagKey<Item> DYES_BLUE = tag("dyes_blue");
    public static final TagKey<Item> DYES_PURPLE = tag("dyes_purple");
    public static final TagKey<Item> DYES_CYAN = tag("dyes_cyan");
    public static final TagKey<Item> DYES_LIGHT_GRAY = tag("dyes_light_gray");
    public static final TagKey<Item> DYES_GRAY = tag("dyes_gray");
    public static final TagKey<Item> DYES_PINK = tag("dyes_pink");
    public static final TagKey<Item> DYES_LIME = tag("dyes_lime");
    public static final TagKey<Item> DYES_YELLOW = tag("dyes_yellow");
    public static final TagKey<Item> DYES_LIGHT_BLUE = tag("dyes_light_blue");
    public static final TagKey<Item> DYES_MAGENTA = tag("dyes_magenta");
    public static final TagKey<Item> DYES_ORANGE = tag("dyes_orange");
    public static final TagKey<Item> DYES_WHITE = tag("dyes_white");
    ...
    private MagnetosphereItemTags() {
    }

    private static TagKey<Item> tag(String path) {
        return TagRegistry.bindItem(Magnetosphere.location(path));
    }
}
