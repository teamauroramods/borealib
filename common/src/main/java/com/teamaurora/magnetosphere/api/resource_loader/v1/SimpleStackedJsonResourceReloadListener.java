...
import com.teamaurora.magnetosphere.api.resource_condition.v1.ResourceConditionRegistry;
import com.teamaurora.magnetosphere.core.Magnetosphere;
import com.teamaurora.magnetosphere.impl.content_registries.ContentRegistryFile;
            ...
            for (Map.Entry<ResourceLocation, List<Resource>> resourceEntry : resources.entrySet()) {
                ...
                for (Resource resource : resourceEntry.getValue()) {
                    try {
                        ...
                        Magnetosphere.LOGGER.error("Couldn't parse data file " + idToUse + " from " + rawId, e);
                    }
                }
            }
        }
