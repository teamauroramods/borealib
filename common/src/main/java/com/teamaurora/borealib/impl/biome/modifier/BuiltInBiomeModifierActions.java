...
public class BuiltInBiomeModifierActions {
    ...
    private static final RegistryReference<Codec<SkyColorModification>> SKY_COLOR_MODIFICATION_CODEC = BorealibRegistries.BIOME_MODIFIER_ACTION_TYPES.getProvider().register("modify_sky_color", () -> Codec.INT.xmap(SkyColorModification::new, SkyColorModification::skyColor).fieldOf("sky_color").codec());
