...
import com.teamaurora.borealib.api.registry.v1.extended.EntityRegistryProvider;
...
public final class BorealibEntityTypes {
    ...
    @ApiStatus.Internal
    public static final EntityRegistryProvider ENTITIES = EntityRegistryProvider.create(Borealib.MOD_ID);
