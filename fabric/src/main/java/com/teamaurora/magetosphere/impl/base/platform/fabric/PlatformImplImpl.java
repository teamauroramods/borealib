package com.teamaurora.magetosphere.impl.base.platform.fabric;
...
import com.teamaurora.magetosphere.impl.fabric.TesseractFabric;
...
public class PlatformImplImpl {
    ...
    public static Optional<MinecraftServer> getRunningServer() {
        return Optional.ofNullable(TesseractFabric.getServer());
    }
}
