...
@ApiStatus.Internal
public class ModConfigImpl implements com.teamaurora.magnetosphere.api.config.v1.ModConfig {
    ...
    @Override
    public com.teamaurora.magnetosphere.api.config.v1.ModConfig.Type getType() {
