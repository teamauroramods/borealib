package com.teamaurora.magnetosphere.impl.convention_tags.forge;
...
public class ConventionTagSynchronizerImpl {
    ...
    public static void init() {
        ...
        TagRegistry.syncTags(Registries.ENTITY_TYPE, MagnetosphereEntityTypeTags.BOSSES, Tags.EntityTypes.BOSSES);
    }
}
